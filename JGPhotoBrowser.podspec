#
#  Be sure to run `pod spec lint JGPhotoBrowser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dengni8023/JGPhotoBrowser.git", :tag => "#{s.version}" }
  ...
  s.resource  = "JGPhotoBrowser/*.bundle"
